  ...
  blogItems = [
    {
      ...
      description: 'La startup CashLife entabló una alianza estratégica con el Banco de la Nación.'
    },
    {
    ...
    },
    {
      ...
      description: 'En una reciente evaluación, CashLife obtuvo el primer lugar en el ranking de este año.'
    },
    {
      image: 'assets/images/carrrusel01.jpg',
      title: 'Nuevas Oportunidades de Inversión',
      description: 'CashLife ha abierto nuevas oportunidades de inversión para los usuarios de la plataforma en el extranjero.'
    },
    {
      image: 'assets/images/carrusel02.jpg',
      title: 'Crecimiento de la Cartera de Clientes',
      description: 'La cartera de clientes de CashLife ha crecido un 25% en el último trimestre.'
    },
    {
      image: 'assets/images/carrusel03.jpg',
      title: 'Nuevas Oportunidades de Inversión',
